...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("mongodb");
			params.setVersion("2.0.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2ZlbGdlbC9tb25nb2RiIiwidmVyc2lvbiI6IjIuMC40In19"), c => c.charCodeAt(0)));
