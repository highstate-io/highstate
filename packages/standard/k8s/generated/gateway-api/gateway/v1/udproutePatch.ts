...
export class UDPRoutePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.networking.k8s.io/v1:UDPRoutePatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.UDPRouteSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.UDPRouteStatusPatch>;
...
export interface UDPRoutePatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1.UDPRouteSpecPatch>;
}
