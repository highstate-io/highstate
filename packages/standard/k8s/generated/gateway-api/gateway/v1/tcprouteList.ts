...
export class TCPRouteList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.networking.k8s.io/v1:TCPRouteList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.gateway.v1.TCPRoute[]>;
    /**
