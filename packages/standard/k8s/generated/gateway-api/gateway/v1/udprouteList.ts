...
export class UDPRouteList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.networking.k8s.io/v1:UDPRouteList';
     ...
     */
    declare public readonly items: pulumi.Output<outputs.gateway.v1.UDPRoute[]>;
    /**
