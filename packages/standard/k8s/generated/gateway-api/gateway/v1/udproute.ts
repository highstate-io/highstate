...
export class UDPRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.networking.k8s.io/v1:UDPRoute';
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.UDPRouteSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.UDPRouteStatus>;
