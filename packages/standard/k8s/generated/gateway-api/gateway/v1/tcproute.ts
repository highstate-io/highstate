...
export class TCPRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.networking.k8s.io/v1:TCPRoute';
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.TCPRouteSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.TCPRouteStatus>;
