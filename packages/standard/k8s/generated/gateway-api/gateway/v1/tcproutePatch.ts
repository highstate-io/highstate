...
export class TCPRoutePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.networking.k8s.io/v1:TCPRoutePatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.TCPRouteSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.TCPRouteStatusPatch>;
...
export interface TCPRoutePatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1.TCPRouteSpecPatch>;
}
