...
This was a version bump only for @highstate/k8s to align it with other projects, there were no code changes.
...
- **@highstate/k8s:** configure gateway api versions ([6cfb09a](https://github.com/highstate-io/highstate/commit/6cfb09a))
...
- **@highstate/k8s:** make access scope bindings unique ([618ed27](https://github.com/highstate-io/highstate/commit/618ed27))
...
- **@highstate/k8s.apps:** back up vault statefulset volumes ([c8bed8d](https://github.com/highstate-io/highstate/commit/c8bed8d))
