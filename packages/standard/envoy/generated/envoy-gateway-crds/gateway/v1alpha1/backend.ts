...
export class Backend extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha1.BackendSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha1.BackendStatus>;
