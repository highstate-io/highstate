...
export class BackendTrafficPolicy extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha1.BackendTrafficPolicySpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha1.BackendTrafficPolicyStatus>;
