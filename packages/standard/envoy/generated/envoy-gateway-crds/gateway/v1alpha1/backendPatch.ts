...
export class BackendPatch extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"Backend">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha1.BackendSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha1.BackendStatusPatch>;
