...
export class ClientTrafficPolicy extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha1.ClientTrafficPolicySpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha1.ClientTrafficPolicyStatus>;
