...
export class SecurityPolicy extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha1.SecurityPolicySpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha1.SecurityPolicyStatus>;
