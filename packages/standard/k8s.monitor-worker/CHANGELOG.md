...
- **@highstate/worker-sdk:** migrate workers to connectrpc ([51efc44](https://github.com/highstate-io/highstate/commit/51efc44))
...
- **@highstate/k8s.monitor-worker:** run worker with Bun ([12a7e2f](https://github.com/highstate-io/highstate/commit/12a7e2f))
...
This was a version bump only for @highstate/k8s.monitor-worker to align it with other projects, there were no code changes.
