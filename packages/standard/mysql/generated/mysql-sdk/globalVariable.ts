...
export class GlobalVariable extends pulumi.CustomResource {
    ...
    declare public readonly globalVariableId: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: GlobalVariableArgs | GlobalVariableState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["globalVariableId"] = state?.globalVariableId;
            ...
            resourceInputs["globalVariableId"] = args?.globalVariableId;
            resourceInputs["name"] = args?.name;
            resourceInputs["value"] = args?.value;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(GlobalVariable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface GlobalVariableState {
    globalVariableId?: pulumi.Input<string>;
