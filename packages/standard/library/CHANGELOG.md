...
This was a version bump only for @highstate/library to align it with other projects, there were no code changes.
...
- **@highstate/yandex:** support ssh proxy endpoints ([9c99750](https://github.com/highstate-io/highstate/commit/9c99750))
...
- **@highstate/k3s:** support external worker groups ([6e26c5c](https://github.com/highstate-io/highstate/commit/6e26c5c))
...
- **@highstate/netaminity:** add tunnel management components ([252a3a1](https://github.com/highstate-io/highstate/commit/252a3a1))
...
- add gateway patch units ([9e83f2e](https://github.com/highstate-io/highstate/commit/9e83f2e))
