...
export class UserToken extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/userToken:UserToken';
    ...
    constructor(name: string, argsOrState?: UserTokenArgs | UserTokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserToken.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
