...
export class AcmeCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/acmeCertificate:AcmeCertificate';
     ...
     */
    declare public readonly domains: pulumi.Output<outputs.AcmeCertificateDomain[]>;
    /**
    ...
    constructor(name: string, argsOrState?: AcmeCertificateArgs | AcmeCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AcmeCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AcmeCertificateState {
     ...
     * The list of domains to include in the certificate. At least one domain is required.
     */
    domains?: pulumi.Input<pulumi.Input<inputs.AcmeCertificateDomain>[]>;
    /**
     * The certificate fingerprint.
     */
