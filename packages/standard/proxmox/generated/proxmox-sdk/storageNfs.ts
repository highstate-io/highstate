...
export class StorageNfs extends pulumi.CustomResource {
    /**
     * Get an existing StorageNfs resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StorageNfsState, opts?: pulumi.CustomResourceOptions): StorageNfs {
        return new StorageNfs(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/storageNfs:StorageNfs';

    /**
     * Returns true if the given object is an instance of StorageNfs.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is StorageNfs {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === StorageNfs.__pulumiType;
    }

    /**
     * Configure backup retention settings for the storage type.
     */
    declare public readonly backups: pulumi.Output<outputs.StorageNfsBackups | undefined>;
    /**
     ...
     */
    declare public readonly storageNfsId: pulumi.Output<string>;

    /**
     * Create a StorageNfs resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: StorageNfsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: StorageNfsArgs | StorageNfsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StorageNfsState | undefined;
            ...
            resourceInputs["storageNfsId"] = state?.storageNfsId;
        } else {
            const args = argsOrState as StorageNfsArgs | undefined;
            ...
            if (args?.storageNfsId === undefined && !opts.urn) {
                throw new Error("Missing required property 'storageNfsId'");
            }
            ...
            resourceInputs["storageNfsId"] = args?.storageNfsId;
            resourceInputs["shared"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(StorageNfs.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering StorageNfs resources.
 */
export interface StorageNfsState {
    /**
     * Configure backup retention settings for the storage type.
     */
    backups?: pulumi.Input<inputs.StorageNfsBackups>;
    /**
     * The content types that can be stored on this storage. Valid values: `backup` (VM backups), `images` (VM disk images),
     * `import` (VM disk images for import), `iso` (ISO images), `rootdir` (container root directories), `snippets`
     * (cloud-init, hook scripts, etc.), `vztmpl` (container templates).
     ...
     * The unique identifier of the storage.
     */
    storageNfsId?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a StorageNfs resource.
 */
export interface StorageNfsArgs {
    /**
     * Configure backup retention settings for the storage type.
     */
    backups?: pulumi.Input<inputs.StorageNfsBackups>;
