...
export class SdnZoneQinq extends pulumi.CustomResource {
    /**
     * Get an existing SdnZoneQinq resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SdnZoneQinqState, opts?: pulumi.CustomResourceOptions): SdnZoneQinq {
        return new SdnZoneQinq(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/sdnZoneQinq:SdnZoneQinq';

    /**
     * Returns true if the given object is an instance of SdnZoneQinq.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SdnZoneQinq {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SdnZoneQinq.__pulumiType;
    }
     ...
     */
    declare public readonly sdnZoneQinqId: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a SdnZoneQinq resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SdnZoneQinqArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SdnZoneQinqArgs | SdnZoneQinqState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SdnZoneQinqState | undefined;
            ...
            resourceInputs["sdnZoneQinqId"] = state?.sdnZoneQinqId;
            resourceInputs["serviceVlan"] = state?.serviceVlan;
            resourceInputs["serviceVlanProtocol"] = state?.serviceVlanProtocol;
            resourceInputs["state"] = state?.state;
        } else {
            const args = argsOrState as SdnZoneQinqArgs | undefined;
            if (args?.bridge === undefined && !opts.urn) {
                throw new Error("Missing required property 'bridge'");
            }
            if (args?.sdnZoneQinqId === undefined && !opts.urn) {
                throw new Error("Missing required property 'sdnZoneQinqId'");
            }
            ...
            resourceInputs["sdnZoneQinqId"] = args?.sdnZoneQinqId;
        ...
        super(SdnZoneQinq.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SdnZoneQinq resources.
 */
export interface SdnZoneQinqState {
    /**
     * A local, VLAN-aware bridge that is already configured on each local node
     */
     ...
     * The unique identifier of the SDN zone.
     */
    sdnZoneQinqId?: pulumi.Input<string>;
    /**
     * Service VLAN tag for QinQ. The tag must be between `1` and `4094`.
     */
...
/**
 * The set of arguments for constructing a SdnZoneQinq resource.
 */
export interface SdnZoneQinqArgs {
    /**
     * A local, VLAN-aware bridge that is already configured on each local node
     */
    bridge: pulumi.Input<string>;
