...
export class SdnZoneEvpn extends pulumi.CustomResource {
    /**
     * Get an existing SdnZoneEvpn resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SdnZoneEvpnState, opts?: pulumi.CustomResourceOptions): SdnZoneEvpn {
        return new SdnZoneEvpn(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/sdnZoneEvpn:SdnZoneEvpn';

    /**
     * Returns true if the given object is an instance of SdnZoneEvpn.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SdnZoneEvpn {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SdnZoneEvpn.__pulumiType;
    }
     ...
     */
    declare public readonly sdnZoneEvpnId: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a SdnZoneEvpn resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SdnZoneEvpnArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SdnZoneEvpnArgs | SdnZoneEvpnState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SdnZoneEvpnState | undefined;
            ...
            resourceInputs["sdnZoneEvpnId"] = state?.sdnZoneEvpnId;
            resourceInputs["state"] = state?.state;
            resourceInputs["vrfVxlan"] = state?.vrfVxlan;
        } else {
            const args = argsOrState as SdnZoneEvpnArgs | undefined;
            if (args?.controller === undefined && !opts.urn) {
                throw new Error("Missing required property 'controller'");
            }
            if (args?.sdnZoneEvpnId === undefined && !opts.urn) {
                throw new Error("Missing required property 'sdnZoneEvpnId'");
            }
            ...
            resourceInputs["sdnZoneEvpnId"] = args?.sdnZoneEvpnId;
            resourceInputs["vrfVxlan"] = args?.vrfVxlan;
            resourceInputs["pending"] = undefined /*out*/;
            resourceInputs["state"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(SdnZoneEvpn.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SdnZoneEvpn resources.
 */
export interface SdnZoneEvpnState {
    /**
     * Enable subnet advertisement for EVPN.
     */
     ...
     * The unique identifier of the SDN zone.
     */
    sdnZoneEvpnId?: pulumi.Input<string>;
    /**
     * Indicates the current state of the zone.
     */
...
/**
 * The set of arguments for constructing a SdnZoneEvpn resource.
 */
export interface SdnZoneEvpnArgs {
    /**
     * Enable subnet advertisement for EVPN.
     */
    advertiseSubnets?: pulumi.Input<boolean>;
