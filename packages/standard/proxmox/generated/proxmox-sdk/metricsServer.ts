...
export class MetricsServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/metricsServer:MetricsServer';
    ...
    /**
     * An API path prefix inserted between `<host>:<port>/` and `/api2/`. Can be useful if the InfluxDB service runs behind a
     * reverse proxy.
     */
    ...
    /**
     * The InfluxDB access token. Only necessary when using the http v2 api. If the v2 compatibility api is used, use
    ...
    /**
     * MTU (maximum transmission unit) for metrics transmission over UDP. If not set, PVE default is `1500` (allowed `512` -
     * `65536`).
     */
