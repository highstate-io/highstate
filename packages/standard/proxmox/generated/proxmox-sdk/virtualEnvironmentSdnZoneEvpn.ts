...
export class VirtualEnvironmentSdnZoneEvpn extends pulumi.CustomResource {
    /**
     * Get an existing VirtualEnvironmentSdnZoneEvpn resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualEnvironmentSdnZoneEvpnState, opts?: pulumi.CustomResourceOptions): VirtualEnvironmentSdnZoneEvpn {
        return new VirtualEnvironmentSdnZoneEvpn(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/virtualEnvironmentSdnZoneEvpn:VirtualEnvironmentSdnZoneEvpn';

    /**
     * Returns true if the given object is an instance of VirtualEnvironmentSdnZoneEvpn.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualEnvironmentSdnZoneEvpn {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualEnvironmentSdnZoneEvpn.__pulumiType;
    }
     ...
     */
    declare public readonly virtualEnvironmentSdnZoneEvpnId: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a VirtualEnvironmentSdnZoneEvpn resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualEnvironmentSdnZoneEvpnArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualEnvironmentSdnZoneEvpnArgs | VirtualEnvironmentSdnZoneEvpnState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualEnvironmentSdnZoneEvpnState | undefined;
            ...
            resourceInputs["virtualEnvironmentSdnZoneEvpnId"] = state?.virtualEnvironmentSdnZoneEvpnId;
            resourceInputs["vrfVxlan"] = state?.vrfVxlan;
        } else {
            const args = argsOrState as VirtualEnvironmentSdnZoneEvpnArgs | undefined;
            if (args?.controller === undefined && !opts.urn) {
                throw new Error("Missing required property 'controller'");
            }
            if (args?.virtualEnvironmentSdnZoneEvpnId === undefined && !opts.urn) {
                throw new Error("Missing required property 'virtualEnvironmentSdnZoneEvpnId'");
            }
            ...
            resourceInputs["virtualEnvironmentSdnZoneEvpnId"] = args?.virtualEnvironmentSdnZoneEvpnId;
            resourceInputs["vrfVxlan"] = args?.vrfVxlan;
            resourceInputs["pending"] = undefined /*out*/;
            resourceInputs["state"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(VirtualEnvironmentSdnZoneEvpn.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VirtualEnvironmentSdnZoneEvpn resources.
 */
export interface VirtualEnvironmentSdnZoneEvpnState {
    /**
     * Enable subnet advertisement for EVPN.
     */
     ...
     * The unique identifier of the SDN zone.
     */
    virtualEnvironmentSdnZoneEvpnId?: pulumi.Input<string>;
    /**
     * VRF VXLAN-ID used for dedicated routing interconnect between VNets. It must be different than the VXLAN-ID of the VNets.
     */
...
/**
 * The set of arguments for constructing a VirtualEnvironmentSdnZoneEvpn resource.
 */
export interface VirtualEnvironmentSdnZoneEvpnArgs {
    /**
     * Enable subnet advertisement for EVPN.
     */
    advertiseSubnets?: pulumi.Input<boolean>;
