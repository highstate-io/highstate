...
export class Harule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/harule:Harule';
    ...
    constructor(name: string, argsOrState?: HaruleArgs | HaruleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Harule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
