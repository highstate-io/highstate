...
export class VirtualEnvironmentStorageCifs extends pulumi.CustomResource {
    /**
     * Get an existing VirtualEnvironmentStorageCifs resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualEnvironmentStorageCifsState, opts?: pulumi.CustomResourceOptions): VirtualEnvironmentStorageCifs {
        return new VirtualEnvironmentStorageCifs(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/virtualEnvironmentStorageCifs:VirtualEnvironmentStorageCifs';

    /**
     * Returns true if the given object is an instance of VirtualEnvironmentStorageCifs.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualEnvironmentStorageCifs {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualEnvironmentStorageCifs.__pulumiType;
    }

    /**
     * Configure backup retention settings for the storage type.
     */
    declare public readonly backups: pulumi.Output<outputs.VirtualEnvironmentStorageCifsBackups | undefined>;
    /**
     ...
     */
    declare public readonly virtualEnvironmentStorageCifsId: pulumi.Output<string>;

    /**
     * Create a VirtualEnvironmentStorageCifs resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualEnvironmentStorageCifsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualEnvironmentStorageCifsArgs | VirtualEnvironmentStorageCifsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualEnvironmentStorageCifsState | undefined;
            ...
            resourceInputs["virtualEnvironmentStorageCifsId"] = state?.virtualEnvironmentStorageCifsId;
        } else {
            const args = argsOrState as VirtualEnvironmentStorageCifsArgs | undefined;
            ...
            if (args?.virtualEnvironmentStorageCifsId === undefined && !opts.urn) {
                throw new Error("Missing required property 'virtualEnvironmentStorageCifsId'");
            }
            ...
            resourceInputs["virtualEnvironmentStorageCifsId"] = args?.virtualEnvironmentStorageCifsId;
            resourceInputs["shared"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        const secretOpts = { additionalSecretOutputs: ["password"] };
        opts = pulumi.mergeOptions(opts, secretOpts);
        super(VirtualEnvironmentStorageCifs.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VirtualEnvironmentStorageCifs resources.
 */
export interface VirtualEnvironmentStorageCifsState {
    /**
     * Configure backup retention settings for the storage type.
     */
    backups?: pulumi.Input<inputs.VirtualEnvironmentStorageCifsBackups>;
    /**
     * The content types that can be stored on this storage. Valid values: `backup` (VM backups), `images` (VM disk images),
     * `import` (VM disk images for import), `iso` (ISO images), `rootdir` (container root directories), `snippets`
     * (cloud-init, hook scripts, etc.), `vztmpl` (container templates).
     ...
     * The unique identifier of the storage.
     */
    virtualEnvironmentStorageCifsId?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a VirtualEnvironmentStorageCifs resource.
 */
export interface VirtualEnvironmentStorageCifsArgs {
    /**
     * Configure backup retention settings for the storage type.
     */
    backups?: pulumi.Input<inputs.VirtualEnvironmentStorageCifsBackups>;
