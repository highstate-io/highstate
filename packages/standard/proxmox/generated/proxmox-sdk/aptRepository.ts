...
export class AptRepository extends pulumi.CustomResource {
    /**
     * Get an existing AptRepository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AptRepositoryState, opts?: pulumi.CustomResourceOptions): AptRepository {
        return new AptRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/aptRepository:AptRepository';

    /**
     * Returns true if the given object is an instance of AptRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AptRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AptRepository.__pulumiType;
    }
    ...
    /**
     * Create a AptRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AptRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AptRepositoryArgs | AptRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AptRepositoryState | undefined;
            ...
            const args = argsOrState as AptRepositoryArgs | undefined;
        ...
        super(AptRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AptRepository resources.
 */
export interface AptRepositoryState {
    /**
     * The associated comment.
     */
...
/**
 * The set of arguments for constructing a AptRepository resource.
 */
