...
export class Hagroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/hagroup:Hagroup';
    ...
    constructor(name: string, argsOrState?: HagroupArgs | HagroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Hagroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
