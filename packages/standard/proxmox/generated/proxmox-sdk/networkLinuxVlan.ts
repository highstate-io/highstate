...
export class NetworkLinuxVlan extends pulumi.CustomResource {
    /**
     * Get an existing NetworkLinuxVlan resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkLinuxVlanState, opts?: pulumi.CustomResourceOptions): NetworkLinuxVlan {
        return new NetworkLinuxVlan(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/networkLinuxVlan:NetworkLinuxVlan';

    /**
     * Returns true if the given object is an instance of NetworkLinuxVlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkLinuxVlan {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkLinuxVlan.__pulumiType;
    }
    ...
    /**
     * Create a NetworkLinuxVlan resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NetworkLinuxVlanArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkLinuxVlanArgs | NetworkLinuxVlanState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkLinuxVlanState | undefined;
            ...
            const args = argsOrState as NetworkLinuxVlanArgs | undefined;
        ...
        super(NetworkLinuxVlan.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NetworkLinuxVlan resources.
 */
export interface NetworkLinuxVlanState {
    /**
     * The interface IPv4/CIDR address.
     */
...
/**
 * The set of arguments for constructing a NetworkLinuxVlan resource.
 */
export interface NetworkLinuxVlanArgs {
    /**
     * The interface IPv4/CIDR address.
     */
    address?: pulumi.Input<string>;
