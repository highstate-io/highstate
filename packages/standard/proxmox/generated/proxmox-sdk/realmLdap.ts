...
export class RealmLdap extends pulumi.CustomResource {
    /**
     * Get an existing RealmLdap resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RealmLdapState, opts?: pulumi.CustomResourceOptions): RealmLdap {
        return new RealmLdap(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/realmLdap:RealmLdap';

    /**
     * Returns true if the given object is an instance of RealmLdap.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RealmLdap {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RealmLdap.__pulumiType;
    }
    ...
    /**
     * Create a RealmLdap resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RealmLdapArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RealmLdapArgs | RealmLdapState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RealmLdapState | undefined;
            ...
            const args = argsOrState as RealmLdapArgs | undefined;
        ...
        super(RealmLdap.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RealmLdap resources.
 */
export interface RealmLdapState {
    /**
     * LDAP base DN for user searches (e.g., 'ou=users,dc=example,dc=com').
     */
...
/**
 * The set of arguments for constructing a RealmLdap resource.
 */
export interface RealmLdapArgs {
    /**
     * LDAP base DN for user searches (e.g., 'ou=users,dc=example,dc=com').
     */
    baseDn: pulumi.Input<string>;
