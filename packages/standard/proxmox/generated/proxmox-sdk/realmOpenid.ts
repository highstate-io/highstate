...
export class RealmOpenid extends pulumi.CustomResource {
    /**
     * Get an existing RealmOpenid resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RealmOpenidState, opts?: pulumi.CustomResourceOptions): RealmOpenid {
        return new RealmOpenid(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/realmOpenid:RealmOpenid';

    /**
     * Returns true if the given object is an instance of RealmOpenid.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RealmOpenid {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RealmOpenid.__pulumiType;
    }
    ...
    /**
     * Create a RealmOpenid resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RealmOpenidArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RealmOpenidArgs | RealmOpenidState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RealmOpenidState | undefined;
            ...
            const args = argsOrState as RealmOpenidArgs | undefined;
        ...
        super(RealmOpenid.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RealmOpenid resources.
 */
export interface RealmOpenidState {
    /**
     * Authentication Context Class Reference values for the OpenID provider.
     */
...
/**
 * The set of arguments for constructing a RealmOpenid resource.
 */
export interface RealmOpenidArgs {
    /**
     * Authentication Context Class Reference values for the OpenID provider.
     */
    acrValues?: pulumi.Input<string>;
