...
export class Haresource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/haresource:Haresource';
    ...
    constructor(name: string, argsOrState?: HaresourceArgs | HaresourceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Haresource.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
