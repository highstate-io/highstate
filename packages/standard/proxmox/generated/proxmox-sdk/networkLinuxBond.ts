...
export class NetworkLinuxBond extends pulumi.CustomResource {
    /**
     * Get an existing NetworkLinuxBond resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkLinuxBondState, opts?: pulumi.CustomResourceOptions): NetworkLinuxBond {
        return new NetworkLinuxBond(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/networkLinuxBond:NetworkLinuxBond';

    /**
     * Returns true if the given object is an instance of NetworkLinuxBond.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkLinuxBond {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkLinuxBond.__pulumiType;
    }
    ...
    /**
     * The bonding mode. Possible values are `balance-rr`, `active-backup`, `balance-xor`, `broadcast`, `802.3ad`,
    ...
    /**
     * The transmit hash policy for `balance-xor` and `802.3ad` bond modes. Possible values are `layer2`, `layer2+3`,
     * `layer3+4`.
     */
    ...
    /**
     * The interface name. Must be `bond[N]`, where 0 ≤ N (e.g. bond0, bond1), or any alphanumeric string that starts with a
     * character and is at most 10 characters long.
     */
    ...
    /**
     * Create a NetworkLinuxBond resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NetworkLinuxBondArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkLinuxBondArgs | NetworkLinuxBondState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkLinuxBondState | undefined;
            ...
            const args = argsOrState as NetworkLinuxBondArgs | undefined;
        ...
        super(NetworkLinuxBond.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NetworkLinuxBond resources.
 */
export interface NetworkLinuxBondState {
    /**
     * The interface IPv4/CIDR address.
     */
...
/**
 * The set of arguments for constructing a NetworkLinuxBond resource.
 */
export interface NetworkLinuxBondArgs {
    /**
     * The interface IPv4/CIDR address.
     */
    address?: pulumi.Input<string>;
