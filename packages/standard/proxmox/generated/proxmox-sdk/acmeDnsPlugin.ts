...
export class AcmeDnsPlugin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/acmeDnsPlugin:AcmeDnsPlugin';
    ...
    constructor(name: string, argsOrState?: AcmeDnsPluginArgs | AcmeDnsPluginState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AcmeDnsPlugin.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
