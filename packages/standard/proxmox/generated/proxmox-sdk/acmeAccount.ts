...
export class AcmeAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'proxmox:index/acmeAccount:AcmeAccount';
    ...
    constructor(name: string, argsOrState?: AcmeAccountArgs | AcmeAccountState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AcmeAccount.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
