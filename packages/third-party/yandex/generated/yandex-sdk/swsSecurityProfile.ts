...
export class SwsSecurityProfile extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SwsSecurityProfileArgs | SwsSecurityProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["swsSecurityProfileId"] = state?.swsSecurityProfileId;
            ...
            resourceInputs["swsSecurityProfileId"] = args?.swsSecurityProfileId;
            resourceInputs["timeouts"] = args?.timeouts;
            resourceInputs["createdAt"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(SwsSecurityProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
