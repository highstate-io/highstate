...
export class ServerlessEventrouterConnector extends pulumi.CustomResource {
    ...
    declare public readonly serverlessEventrouterConnectorId: pulumi.Output<string>;
    declare public readonly timeouts: pulumi.Output<outputs.ServerlessEventrouterConnectorTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ServerlessEventrouterConnectorArgs | ServerlessEventrouterConnectorState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["serverlessEventrouterConnectorId"] = state?.serverlessEventrouterConnectorId;
            ...
            resourceInputs["serverlessEventrouterConnectorId"] = args?.serverlessEventrouterConnectorId;
        ...
        super(ServerlessEventrouterConnector.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ServerlessEventrouterConnectorState {
    ...
    serverlessEventrouterConnectorId?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.ServerlessEventrouterConnectorTimeouts>;
    /**
     * Timer source of the connector
     */
