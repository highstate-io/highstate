...
export class OrganizationmanagerGroupMappingItem extends pulumi.CustomResource {
    ...
    declare public readonly organizationmanagerGroupMappingItemId: pulumi.Output<string>;
    declare public readonly timeouts: pulumi.Output<outputs.OrganizationmanagerGroupMappingItemTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: OrganizationmanagerGroupMappingItemArgs | OrganizationmanagerGroupMappingItemState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["organizationmanagerGroupMappingItemId"] = state?.organizationmanagerGroupMappingItemId;
            ...
            resourceInputs["organizationmanagerGroupMappingItemId"] = args?.organizationmanagerGroupMappingItemId;
            resourceInputs["timeouts"] = args?.timeouts;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(OrganizationmanagerGroupMappingItem.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface OrganizationmanagerGroupMappingItemState {
    ...
    organizationmanagerGroupMappingItemId?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.OrganizationmanagerGroupMappingItemTimeouts>;
}
