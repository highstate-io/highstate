...
export class IamServiceAccountIamPolicy extends pulumi.CustomResource {
    ...
    declare public readonly iamServiceAccountIamPolicyId: pulumi.Output<string>;
    declare public readonly policyData: pulumi.Output<string>;
    declare public readonly serviceAccountId: pulumi.Output<string>;
    declare public readonly timeouts: pulumi.Output<outputs.IamServiceAccountIamPolicyTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: IamServiceAccountIamPolicyArgs | IamServiceAccountIamPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["iamServiceAccountIamPolicyId"] = state?.iamServiceAccountIamPolicyId;
            ...
            resourceInputs["iamServiceAccountIamPolicyId"] = args?.iamServiceAccountIamPolicyId;
            resourceInputs["policyData"] = args?.policyData;
            resourceInputs["serviceAccountId"] = args?.serviceAccountId;
            resourceInputs["timeouts"] = args?.timeouts;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(IamServiceAccountIamPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface IamServiceAccountIamPolicyState {
    iamServiceAccountIamPolicyId?: pulumi.Input<string>;
    policyData?: pulumi.Input<string>;
    serviceAccountId?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.IamServiceAccountIamPolicyTimeouts>;
}
