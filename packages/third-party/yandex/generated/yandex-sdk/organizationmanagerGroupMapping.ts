...
export class OrganizationmanagerGroupMapping extends pulumi.CustomResource {
    ...
    declare public readonly organizationmanagerGroupMappingId: pulumi.Output<string>;
    declare public readonly timeouts: pulumi.Output<outputs.OrganizationmanagerGroupMappingTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: OrganizationmanagerGroupMappingArgs | OrganizationmanagerGroupMappingState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["organizationmanagerGroupMappingId"] = state?.organizationmanagerGroupMappingId;
            ...
            resourceInputs["organizationmanagerGroupMappingId"] = args?.organizationmanagerGroupMappingId;
            resourceInputs["timeouts"] = args?.timeouts;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(OrganizationmanagerGroupMapping.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface OrganizationmanagerGroupMappingState {
    ...
    organizationmanagerGroupMappingId?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.OrganizationmanagerGroupMappingTimeouts>;
}
