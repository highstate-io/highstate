...
export class MdbKafkaConnector extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: MdbKafkaConnectorArgs | MdbKafkaConnectorState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["mdbKafkaConnectorId"] = state?.mdbKafkaConnectorId;
            ...
            resourceInputs["mdbKafkaConnectorId"] = args?.mdbKafkaConnectorId;
            resourceInputs["name"] = args?.name;
            resourceInputs["properties"] = args?.properties;
            resourceInputs["tasksMax"] = args?.tasksMax;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(MdbKafkaConnector.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
