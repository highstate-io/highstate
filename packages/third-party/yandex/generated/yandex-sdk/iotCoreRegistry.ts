...
export class IotCoreRegistry extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IotCoreRegistryArgs | IotCoreRegistryState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["iotCoreRegistryId"] = state?.iotCoreRegistryId;
            ...
            resourceInputs["iotCoreRegistryId"] = args?.iotCoreRegistryId;
        ...
        super(IotCoreRegistry.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
