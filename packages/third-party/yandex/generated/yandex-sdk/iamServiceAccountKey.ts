...
export class IamServiceAccountKey extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IamServiceAccountKeyArgs | IamServiceAccountKeyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["iamServiceAccountKeyId"] = state?.iamServiceAccountKeyId;
            ...
            resourceInputs["iamServiceAccountKeyId"] = args?.iamServiceAccountKeyId;
        ...
        super(IamServiceAccountKey.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
