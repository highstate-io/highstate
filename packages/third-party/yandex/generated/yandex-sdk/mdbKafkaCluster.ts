...
export class MdbKafkaCluster extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: MdbKafkaClusterArgs | MdbKafkaClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["mdbKafkaClusterId"] = state?.mdbKafkaClusterId;
            ...
            resourceInputs["mdbKafkaClusterId"] = args?.mdbKafkaClusterId;
        ...
        super(MdbKafkaCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
