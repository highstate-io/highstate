...
export class OrganizationmanagerGroupMembership extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: OrganizationmanagerGroupMembershipArgs | OrganizationmanagerGroupMembershipState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["organizationmanagerGroupMembershipId"] = state?.organizationmanagerGroupMembershipId;
            ...
            resourceInputs["organizationmanagerGroupMembershipId"] = args?.organizationmanagerGroupMembershipId;
            resourceInputs["timeouts"] = args?.timeouts;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(OrganizationmanagerGroupMembership.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
