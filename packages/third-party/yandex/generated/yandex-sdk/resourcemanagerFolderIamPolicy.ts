...
export class ResourcemanagerFolderIamPolicy extends pulumi.CustomResource {
    ...
    declare public readonly resourcemanagerFolderIamPolicyId: pulumi.Output<string>;
    declare public readonly timeouts: pulumi.Output<outputs.ResourcemanagerFolderIamPolicyTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ResourcemanagerFolderIamPolicyArgs | ResourcemanagerFolderIamPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["resourcemanagerFolderIamPolicyId"] = state?.resourcemanagerFolderIamPolicyId;
            ...
            resourceInputs["resourcemanagerFolderIamPolicyId"] = args?.resourcemanagerFolderIamPolicyId;
            resourceInputs["timeouts"] = args?.timeouts;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(ResourcemanagerFolderIamPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ResourcemanagerFolderIamPolicyState {
    ...
    resourcemanagerFolderIamPolicyId?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.ResourcemanagerFolderIamPolicyTimeouts>;
}
