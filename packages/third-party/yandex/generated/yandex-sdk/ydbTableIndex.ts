...
export class YdbTableIndex extends pulumi.CustomResource {
    ...
    declare public readonly timeouts: pulumi.Output<outputs.YdbTableIndexTimeouts | undefined>;
    declare public readonly type: pulumi.Output<string>;
    declare public readonly ydbTableIndexId: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: YdbTableIndexArgs | YdbTableIndexState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ydbTableIndexId"] = state?.ydbTableIndexId;
        } else {
            ...
            resourceInputs["ydbTableIndexId"] = args?.ydbTableIndexId;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(YdbTableIndex.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface YdbTableIndexState {
    ...
    timeouts?: pulumi.Input<inputs.YdbTableIndexTimeouts>;
    type?: pulumi.Input<string>;
    ydbTableIndexId?: pulumi.Input<string>;
}
