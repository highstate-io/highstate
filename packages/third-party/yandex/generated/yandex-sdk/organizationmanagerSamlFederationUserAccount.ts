...
export class OrganizationmanagerSamlFederationUserAccount extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: OrganizationmanagerSamlFederationUserAccountArgs | OrganizationmanagerSamlFederationUserAccountState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["organizationmanagerSamlFederationUserAccountId"] = state?.organizationmanagerSamlFederationUserAccountId;
            ...
            resourceInputs["organizationmanagerSamlFederationUserAccountId"] = args?.organizationmanagerSamlFederationUserAccountId;
            resourceInputs["timeouts"] = args?.timeouts;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(OrganizationmanagerSamlFederationUserAccount.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
