...
export class OrganizationmanagerOrganizationIamMember extends pulumi.CustomResource {
    ...
    declare public readonly organizationmanagerOrganizationIamMemberId: pulumi.Output<string>;
    declare public readonly role: pulumi.Output<string>;
    declare public readonly sleepAfter: pulumi.Output<number | undefined>;
    declare public readonly timeouts: pulumi.Output<outputs.OrganizationmanagerOrganizationIamMemberTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: OrganizationmanagerOrganizationIamMemberArgs | OrganizationmanagerOrganizationIamMemberState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["organizationmanagerOrganizationIamMemberId"] = state?.organizationmanagerOrganizationIamMemberId;
            ...
            resourceInputs["organizationmanagerOrganizationIamMemberId"] = args?.organizationmanagerOrganizationIamMemberId;
            resourceInputs["role"] = args?.role;
            resourceInputs["sleepAfter"] = args?.sleepAfter;
            resourceInputs["timeouts"] = args?.timeouts;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(OrganizationmanagerOrganizationIamMember.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface OrganizationmanagerOrganizationIamMemberState {
    ...
    organizationmanagerOrganizationIamMemberId?: pulumi.Input<string>;
    role?: pulumi.Input<string>;
    sleepAfter?: pulumi.Input<number>;
    timeouts?: pulumi.Input<inputs.OrganizationmanagerOrganizationIamMemberTimeouts>;
}
