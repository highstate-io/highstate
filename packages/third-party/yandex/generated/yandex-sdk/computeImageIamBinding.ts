...
export class ComputeImageIamBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'yandex:index/computeImageIamBinding:ComputeImageIamBinding';
     ...
     */
    declare public readonly computeImageIamBindingId: pulumi.Output<string>;
    /**
    ...
    /**
     * The role that should be assigned. Only one yandex.ComputeImageIamBinding can be used per role.
     */
    ...
    constructor(name: string, argsOrState?: ComputeImageIamBindingArgs | ComputeImageIamBindingState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["computeImageIamBindingId"] = state?.computeImageIamBindingId;
            ...
            resourceInputs["computeImageIamBindingId"] = args?.computeImageIamBindingId;
...
export interface ComputeImageIamBindingState {
     ...
     * The ID of this resource.
     */
    computeImageIamBindingId?: pulumi.Input<string>;
    /**
     * The ID of the compute `image` to attach the policy to.
     */
