...
export class VpcPrivateEndpoint extends pulumi.CustomResource {
     ...
     */
    declare public readonly dnsOptions: pulumi.Output<outputs.VpcPrivateEndpointDnsOptions | undefined>;
    /**
     * Private endpoint address specification block. > Only one of `address_id` or `subnet_id` + `address` arguments can be
     * specified.
     */
    declare public readonly endpointAddress: pulumi.Output<outputs.VpcPrivateEndpointEndpointAddress | undefined>;
    /**
    ...
    declare public readonly timeouts: pulumi.Output<outputs.VpcPrivateEndpointTimeouts | undefined>;
    declare public readonly vpcPrivateEndpointId: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: VpcPrivateEndpointArgs | VpcPrivateEndpointState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["vpcPrivateEndpointId"] = state?.vpcPrivateEndpointId;
        } else {
            ...
            resourceInputs["vpcPrivateEndpointId"] = args?.vpcPrivateEndpointId;
            resourceInputs["createdAt"] = undefined /*out*/;
            resourceInputs["status"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(VpcPrivateEndpoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpcPrivateEndpointState {
    ...
    timeouts?: pulumi.Input<inputs.VpcPrivateEndpointTimeouts>;
    vpcPrivateEndpointId?: pulumi.Input<string>;
}
