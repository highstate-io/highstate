...
export class MdbKafkaTopic extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: MdbKafkaTopicArgs | MdbKafkaTopicState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["mdbKafkaTopicId"] = state?.mdbKafkaTopicId;
            ...
            resourceInputs["mdbKafkaTopicId"] = args?.mdbKafkaTopicId;
        ...
        super(MdbKafkaTopic.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
