...
export class ContainerRegistryIpPermission extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ContainerRegistryIpPermissionArgs | ContainerRegistryIpPermissionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["containerRegistryIpPermissionId"] = state?.containerRegistryIpPermissionId;
            ...
            resourceInputs["containerRegistryIpPermissionId"] = args?.containerRegistryIpPermissionId;
        ...
        super(ContainerRegistryIpPermission.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
