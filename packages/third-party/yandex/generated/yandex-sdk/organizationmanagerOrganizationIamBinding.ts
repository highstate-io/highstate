...
export class OrganizationmanagerOrganizationIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly organizationmanagerOrganizationIamBindingId: pulumi.Output<string>;
    declare public readonly role: pulumi.Output<string>;
    declare public readonly sleepAfter: pulumi.Output<number | undefined>;
    declare public readonly timeouts: pulumi.Output<outputs.OrganizationmanagerOrganizationIamBindingTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: OrganizationmanagerOrganizationIamBindingArgs | OrganizationmanagerOrganizationIamBindingState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["organizationmanagerOrganizationIamBindingId"] = state?.organizationmanagerOrganizationIamBindingId;
            ...
            resourceInputs["organizationmanagerOrganizationIamBindingId"] = args?.organizationmanagerOrganizationIamBindingId;
            resourceInputs["role"] = args?.role;
            resourceInputs["sleepAfter"] = args?.sleepAfter;
            resourceInputs["timeouts"] = args?.timeouts;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(OrganizationmanagerOrganizationIamBinding.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface OrganizationmanagerOrganizationIamBindingState {
    ...
    organizationmanagerOrganizationIamBindingId?: pulumi.Input<string>;
    role?: pulumi.Input<string>;
    sleepAfter?: pulumi.Input<number>;
    timeouts?: pulumi.Input<inputs.OrganizationmanagerOrganizationIamBindingTimeouts>;
}
