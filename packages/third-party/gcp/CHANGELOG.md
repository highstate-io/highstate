...
This was a version bump only for @highstate/gcp to align it with other projects, there were no code changes.
...
- **@highstate/gcp:** retain private instance endpoints ([8cd253a](https://github.com/highstate-io/highstate/commit/8cd253a))
