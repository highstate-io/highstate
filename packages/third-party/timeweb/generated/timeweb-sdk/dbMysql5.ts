...
export class DbMysql5 extends pulumi.CustomResource {
    /**
     * Get an existing DbMysql5 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbMysql5State, opts?: pulumi.CustomResourceOptions): DbMysql5 {
        return new DbMysql5(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'timeweb-cloud:index/dbMysql5:DbMysql5';

    /**
     * Returns true if the given object is an instance of DbMysql5.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DbMysql5 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DbMysql5.__pulumiType;
    }
    ...
    declare public readonly dbMysql5Id: pulumi.Output<string>;
    /**
     * Information about database disk stats
     */
    declare public /*out*/ readonly diskStats: pulumi.Output<outputs.DbMysql5DiskStat[]>;
    /**
     ...
     */
    declare public readonly localNetwork: pulumi.Output<outputs.DbMysql5LocalNetwork | undefined>;
    /**
     * Login for database
     */
     ...
     */
    declare public readonly queryCacheSize: pulumi.Output<number>;
    /**
     * Set the query cache type
     */
    declare public readonly queryCacheType: pulumi.Output<number>;
    /**
    ...
    /**
     * Create a DbMysql5 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DbMysql5Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DbMysql5Args | DbMysql5State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DbMysql5State | undefined;
            ...
            resourceInputs["dbMysql5Id"] = state?.dbMysql5Id;
            ...
            resourceInputs["queryCacheSize"] = state?.queryCacheSize;
            resourceInputs["queryCacheType"] = state?.queryCacheType;
            resourceInputs["sqlModes"] = state?.sqlModes;
            resourceInputs["status"] = state?.status;
        } else {
            const args = argsOrState as DbMysql5Args | undefined;
            ...
            resourceInputs["dbMysql5Id"] = args?.dbMysql5Id;
            ...
            resourceInputs["queryCacheSize"] = args?.queryCacheSize;
            resourceInputs["queryCacheType"] = args?.queryCacheType;
        ...
        super(DbMysql5.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DbMysql5 resources.
 */
export interface DbMysql5State {
    /**
     * Interval between indices between rows for `AUTO_INCREMENT` columns
     */
    ...
    dbMysql5Id?: pulumi.Input<string>;
    /**
     * Information about database disk stats
     */
    diskStats?: pulumi.Input<pulumi.Input<inputs.DbMysql5DiskStat>[]>;
    /**
     * Hash type for database
     */
     ...
     * Flag that enables local network for DB
     */
    localNetwork?: pulumi.Input<inputs.DbMysql5LocalNetwork>;
    /**
     * Login for database
     */
     ...
     * The amount of memory allocated for caching query results
     */
    queryCacheSize?: pulumi.Input<number>;
    /**
     * Set the query cache type
     */
    queryCacheType?: pulumi.Input<number>;
    /**
     * The current server SQL mode
     */
...
/**
 * The set of arguments for constructing a DbMysql5 resource.
 */
export interface DbMysql5Args {
    /**
     * Interval between indices between rows for `AUTO_INCREMENT` columns
     */
    autoIncrementIncrement?: pulumi.Input<number>;
