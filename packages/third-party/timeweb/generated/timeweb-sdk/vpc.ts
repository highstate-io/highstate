...
export class Vpc extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'timeweb-cloud:index/vpc:Vpc';
     ...
     */
    declare public readonly subnetV4: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: VpcArgs | VpcState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["subnetV4"] = state?.subnetV4;
            ...
            if (args?.subnetV4 === undefined && !opts.urn) {
                throw new Error("Missing required property 'subnetV4'");
            }
            resourceInputs["description"] = args?.description;
            resourceInputs["location"] = args?.location;
            resourceInputs["name"] = args?.name;
            resourceInputs["subnetV4"] = args?.subnetV4;
