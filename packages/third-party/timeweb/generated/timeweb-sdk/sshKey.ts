...
export class SshKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'timeweb-cloud:index/sshKey:SshKey';
     ...
     */
    declare public /*out*/ readonly usedBies: pulumi.Output<outputs.SshKeyUsedBy[]>;
    ...
    constructor(name: string, argsOrState?: SshKeyArgs | SshKeyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["sshKeyId"] = args?.sshKeyId;
...
export interface SshKeyState {
     ...
     * Servers that use this SSH key
     */
    usedBies?: pulumi.Input<pulumi.Input<inputs.SshKeyUsedBy>[]>;
}
