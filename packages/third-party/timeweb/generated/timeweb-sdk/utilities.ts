...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("timeweb-cloud");
			params.setVersion("1.5.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoidGYudGltZXdlYi5jbG91ZC90aW1ld2ViLWNsb3VkL3RpbWV3ZWItY2xvdWQiLCJ2ZXJzaW9uIjoiMS41LjIifX0="), c => c.charCodeAt(0)));

			const req = new resproto.RegisterPackageRequest();
			req.setName("terraform-provider");
			req.setVersion("0.7.0");
			req.setDownloadUrl("");
