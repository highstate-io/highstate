...
describe("searchByText", () => {
  globalSearchTest(
    ...
    async ({ database, createProject, project, projectUnlockBackend, globalSearchService, expect }) => {
      // arrange
...
describe("searchByIds", () => {
  globalSearchTest("returns empty result for empty ids", async ({ globalSearchService, expect }) => {
    // act
