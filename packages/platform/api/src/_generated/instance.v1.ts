  ...
  fromJSON(object: any): RemoveCustomStatusRequest {
    return {
      stateId: isSet(object.stateId)
        ...
        ? globalThis.String(object.state_id)
        : "",
      statusName: isSet(object.statusName)
        ? globalThis.String(object.statusName)
        : isSet(object.status_name)
        ? globalThis.String(object.status_name)
        : "",
    };
  },
...
export const InstanceServiceDefinition = {
  ...
  methods: {
    ...
    updateCustomStatus: {
      ...
      requestType: UpdateCustomStatusRequest as typeof UpdateCustomStatusRequest,
      requestStream: false,
    ...
    removeCustomStatus: {
      ...
      requestType: RemoveCustomStatusRequest as typeof RemoveCustomStatusRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
      options: {},
