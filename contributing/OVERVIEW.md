...
**The diagram was generated by `bun run update-diagrams`. Transitive dependencies are omitted for clarity.**
...
The generation in these packages should be triggered by `bun run generate-crds` command.
