...
- [Node.js](https://nodejs.org/) + [Yarn workspaces](https://yarnpkg.com/features/workspaces)
...
**The diagram was generated by `yarn update-diagrams`. Transitive dependencies are omitted for clarity.**
...
The generation in these packages should be triggered by `yarn generate-crds` command.
...
The generation in these packages should be triggered by `yarn generate-sdks` command.
...
The generation in this package should be triggered by `yarn generate-sdk` command.
